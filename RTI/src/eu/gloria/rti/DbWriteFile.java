 ...
 *         &lt;element name="content" type="{http://www.w3.org/2001/XMLSchema}byte" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="metadata" type="{http://gloria.eu/rt/entity/device}dbFileMetadata" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "dbWriteFile")
public class DbWriteFile {
    ...
    protected List<DbFileMetadata> metadata;
     ...
     * 
     */
    public List<DbFileMetadata> getMetadata() {
        if (metadata == null) {
            metadata = new ArrayList<DbFileMetadata>();
        }
