 ...
 *         &lt;element name="states" type="{http://gloria.eu/rt/entity/device}sensorStateIntervalLong" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "strSetDistanceMeasureStates")
public class StrSetDistanceMeasureStates {

    @XmlElement(required = true)
    protected String session;
    @XmlElement(required = true)
    protected String deviceId;
    protected List<SensorStateIntervalLong> states;
     ...
     * 
     */
    public List<SensorStateIntervalLong> getStates() {
        if (states == null) {
            states = new ArrayList<SensorStateIntervalLong>();
        }
        return this.states;
    }
